...
const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () => import('src/app/site/titles/crupdate-title/crupdate-title.module').then(m => m.CrupdateTitleModule),
            },
            {
                path: 'titles/:titleId/:titleName',
                component: TitlePageContainerComponent,
                resolve: {api: TitleResolverService},
                data: {permissions: ['titles.view'], name: MEDIA_TYPE.MOVIE, animationState: 'One'}
            },
            {
            ...
            },
            {
                path: 'people/create',
                component: DefaultPageWrapperComponent,
                loadChildren: () => import('src/app/site/people/crupdate-person/crupdate-person.module').then(m => m.CrupdatePersonModule),
            },
            {
                path: 'people/:id/:name',
