...
export class TitlesService {
    ...
    public getRelatedVideos(params: RelatedVideosParams): BackendResponse<{videos: Video[]}> {
        return this.http.get('related-videos', params);
    }

    public getRelatedTitles(title: Title, params?: {limit: number}): BackendResponse<{titles: Title[]}> {
    ...
    public update(id: number, payload: Partial<Title>): BackendResponse<{title: Title}> {
    ...
    public updateCredit(id: number, payload: TitleCreditPivot): BackendResponse<{credit: TitleCreditPivot}> {
        return this.http.put('titles/credits/' + id, {credit: payload});
    }

    public addCredit(personId: number, creditable: {type: string, id: number}, pivot: TitleCreditPivot): BackendResponse<{credit: TitleCredit}> {
    ...
    public changeCreditsOrder(payload: {[key: number]: number}): BackendResponse<void> {
    ...
    public createEpisode(seasonId: number, payload: Partial<Episode>): BackendResponse<{episode: Episode}> {
        return this.http.post('seasons/' + seasonId + '/episodes', payload);
    }

    public updateEpisode(id: number, payload: Partial<Episode>): BackendResponse<{episode: Episode}> {
        return this.http.put('episodes/' + id, payload);
    }

    public attachTags(titleId: number, params: {tags: string[], tagType: string}): BackendResponse<{tags: Tag[]}> {
    ...
    public import(params: object): BackendResponse<{mediaItem: Title|Person}> {
